package com.hoogle.fileditto.receiver;
...
import static com.hoogle.fileditto.Utils.WifiUtils.connectToOpenWifi;
import static com.hoogle.fileditto.receiver.ReceiverActivity.WifiTasksHandler.SCAN_FOR_WIFI_RESULTS;
import static com.hoogle.fileditto.receiver.ReceiverActivity.WifiTasksHandler.WAIT_FOR_CONNECT_ACTION_TIMEOUT;
import static com.hoogle.fileditto.receiver.ReceiverActivity.WifiTasksHandler.WAIT_FOR_RECONNECT_ACTION_TIMEOUT;
...
public class ReceiverActivity extends AppCompatActivity  {
    ...
    /**
     * Entry point to start receiver mode. Makes calls to register necessary broadcast receivers to start scanning for diito wif
     * @return
     */
    ...
    private boolean checkLocationAccess() {
        ...
        if (!manager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
            Log.e(TAG, "GPS service not enabled");
            //buildAlertMessageNoGps();
            return false;
        }
        return true;
    }
//changed uncommented line 377 to 397
private void buildAlertMessageNoGps() {
    ...
    private void connectToWifi(String ssid) {
        ...
        if (info.getSSID().equals(ssid)) {
            Log.d(TAG, "Already connected to Ditto, add sender Files listing fragment");
            resetWifiScan = false;
            ...
            Log.e(TAG, "connection attempt to Ditto wifi is " + (!resetWifiScan ? "success!!!" : "FAILED..!!!"));
        }
                ...
                if (ConnectivityManager.TYPE_WIFI == netInfo.getType()) {
                    ...
                    if (WifiUtils.isShareThemSSID(info.getSSID())) {
                        if (System.currentTimeMillis() - preferences.getLong(LASTCONNECTEDTIME, 0) >= SYNCTIME && supState.equals(SupplicantState.COMPLETED)) {
                            ...
                            Log.d(TAG, "client connected to fileditto hotspot.  ip address: " + ip);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case WAIT_FOR_CONNECT_ACTION_TIMEOUT:
                    ...
                    activity.m_areOtherNWsDisabled = connectToOpenWifi(activity.wifiManager, (String) msg.obj, true);
